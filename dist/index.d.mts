...
interface UsernameGenerationResponse {
    username: string;
}
...
declare const residentialSchema: z$1.ZodObject<{
    ...
    lastMonthlyPaymentUpdatedAt: z$1.ZodOptional<z$1.ZodNumber>;
    ...
    onboardingUsernameInCharge: z$1.ZodOptional<z$1.ZodString>;
    ...
    onboardingUsernameInCharge?: string | undefined;
...
interface ResidentialAccountLinkDto {
    link: string;
    expiresAt: number;
}
declare const residentialAccountLinkDtoSchema: z$1.ZodObject<{
    link: z$1.ZodString;
...
type ResidentialAccountLinkDtoType = z$1.infer<typeof residentialAccountLinkDtoSchema>;
